<?php /* Smarty version Smarty-3.1.18, created on 2022-10-30 20:47:50
         compiled from "simpla/design/html/order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:808315469635a07f9eba3d2-29346234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '808315469635a07f9eba3d2-29346234',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_635a07fa033149_51033907',
  'variables' => 
  array (
    'manager' => 0,
    'order' => 0,
...
<?php if ($_valid && !is_callable('content_635a07fa033149_51033907')) {function content_635a07fa033149_51033907($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/fj473748/goldrwsbank.com.ua/www/ru/Smarty/libs/plugins/function.math.php';
?>
...
<?php }?>
		...
		<li>
			<label class=property>Город в котором хотят совершить сделку</label>
			<div class="edit_order_detail" style='display:none;'>
				<input name="cityselect" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->cityselect, ENT_QUOTES, 'UTF-8', true);?>
" />
			</div>
			<div class="view_order_detail">
				<?php if ($_smarty_tpl->tpl_vars['order']->value->cityselect) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->cityselect, ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?>Не вказано місто<?php }?>
			</div>
		</li>
		<li>
