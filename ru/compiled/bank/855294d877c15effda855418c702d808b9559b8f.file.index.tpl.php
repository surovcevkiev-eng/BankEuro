<?php /* Smarty version Smarty-3.1.18, created on 2024-08-20 00:36:45
         compiled from "/home/fj473748/goldrwsbank.com.ua/www/ru/design/bank/html/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1827868012634dc7b18aede8-38152497%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '855294d877c15effda855418c702d808b9559b8f' => 
    array (
      0 => '/home/fj473748/goldrwsbank.com.ua/www/ru/design/bank/html/index.tpl',
      1 => 1724103393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1827868012634dc7b18aede8-38152497',
  'function' => 
  array (
    'categories_tree' => 
    array (
  ...
  'unifunc' => 'content_634dc7b18fc341_11366160',
  'variables' => 
  array (
    'config' => 0,
    'meta_title' => 0,
...
<?php if ($_valid && !is_callable('content_634dc7b18fc341_11366160')) {function content_634dc7b18fc341_11366160($_smarty_tpl) {?><!DOCTYPE html>
...
" placeholder="Поиск">
			...
			<div class="bottom-modal modal-box--featured">
					<p>Напишите, что Вас интересует, и мы попытаемся найти информацию для Вас</p>
			</div>
		</div>	
	</dialog>
	<!-- Корзина -->
		...
		<div class="container" id="home">
			<div class="header-top">
				<div class="header-top-left">
					<div class="language">
						<a id="language-btn" class="header-top-link">RU 
				...
				<div class="header-top-right">
					<div class="offices">
                     <a class="header-top-link" href="/ru/contact">
...
" class="w-full h-20">
				...
				<div class="menu-title">АТ "РВС БАНК" <span>ОТДЕЛ БАНКОВСКИХ МЕТАЛЛОВ</span></div>
...
">
					...
					<div class="mobile-menu__item">
						<ul>
							<li>
								<a id="button-drop-privat" class="dropdown-btn" target="_blank">Частным лицам 
									<svg id="svg-privat" class="svg--gray" style="width:21px;height:21px" viewBox="0 0 24 24">
										<path fill="currentColor" d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" />
									</svg>
								</a>
								<ul id="drop-privat" class="dropdown-link-box">
									<li><a href="/ru/kupivlya-cherez-kasu">Покупка через кассу</a></li>
<!--									<li><a href="/ru/kupivlya-cherez-rahunok-fiz-osobi">Покупка через счет физлица</a></li>-->
									<li><a href="/ru/questions-answers">Вопросы - ответы</a></li>
									<li><a href="https://rwsbank.com.ua/" target="_blank">Другие услуги</a></li>
								</ul>
							</li>
<!--
							<li>
								<a id="button-drop-urid" class="dropdown-btn" target="_blank">Юридическим лицам
									<svg id="svg-urid" class="svg--gray" style="width:21px;height:21px" viewBox="0 0 24 24">
										<path fill="currentColor" d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" />
									</svg>
								</a>
								<ul id="drop-urid" class="dropdown-link-box">
									<li><a href="/ru/metalevi-rahunki-yur">Покупка через счет юрлиц</a></li>
									<li><a href="/ru/kupivlya-metaliv-dlya-fop">Покупка металлов для ФЛП</a></li>
									<li><a href="https://rwsbank.com.ua/" target="_blank">Другие услуги</a></li>
								</ul>
							</li>
-->
				...
				<div class="link-price">
					<a id="linkPrice" class="btn" href="/ru/tsini">Цены откупа и продаж
			...
			<div class="header-main">
				<div class="header-title">
					<h1>БАНКОВСКИЕ <br>МЕТАЛЛЫ</h1>
					<p>Инвестируй и умножай надежно!</p>
					<a class="btn-line" href="/ru/catalog/zoloto">Просмотреть каталог</a>
				</div>
			</div>
			<?php }?>
		</div>	
	...
	<section class="container">
		<div class="banner-box">
			<div class="banner-text">
				<h2><span>Оптовая, индивидуальная цена</span>
					– при покупке/продаже от 200 граммов золота или платины или от 10 кг серебра
				</h2>
				<a href="/ru/tsini"><span>Подробнее </span>
					<svg style="width:24px;height:24px" viewBox="0 0 24 24">
	...
	<div class="box-news col">
		<div class="container">
			<div class="main-products-title">
				<h3>Новости</h3>
				<a class="anim-link" href="blog"><span>Все новости</span>
					<svg style="width:24px;height:24px" viewBox="0 0 24 24">
						<path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" />
					</svg>
				</a>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value->name, ENT_QUOTES, 'UTF-8', true);?>
							...
							<p class="blog-box-data"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier($_smarty_tpl->tpl_vars['post']->value->date);?>
</p>
						</li>
					<?php } ?>
				</ul>
...
foreach (Smarty::$global_tpl_vars as $key => $value) if(!isset($_smarty_tpl->tpl_vars[$key])) $_smarty_tpl->tpl_vars[$key] = $value;}}?>
				...
				<div class="footer-top-colums__item">
					<ul>
						<li>
							<a href="https://rwsbank.com.ua/" target="_blank">Другие услуги</a>
						</li>
					</ul>
				</div>
				<div class="footer-top-colums__item">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p']->value->name, ENT_QUOTES, 'UTF-8', true);?>
		...
		<div class="footer-bottom">
			<div class="container footer-bottom-colums">
				...
				<div class="footer-bottom-colums__item">
					<p>«RwS bank», Специализированное отделение по работе с </p>
					<p>банковскими металлами, г. Киев, ул. Белорусская, 8</p>
				</div>
				<div class="footer-bottom-colums__item">
					<p>© 2016 «RwS bank», Лицензия НБУ №277 от 24.11.16</p>
				</div>
			</div>
		</div>
	</footer>
