<?php /* Smarty version Smarty-3.1.18, created on 2024-06-07 18:14:10
         compiled from "/home/fj473748/goldrwsbank.com.ua/www/ru/design/bank/html/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1493002608634dc7bd509dd3-52207473%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9098f7876c4e57f567026c70a088a7b74cacae18' => 
    array (
      0 => '/home/fj473748/goldrwsbank.com.ua/www/ru/design/bank/html/product.tpl',
      1 => 1717773207,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1493002608634dc7bd509dd3-52207473',
  'function' => 
  array (
    'categories_tree' => 
    array (
  ...
  'unifunc' => 'content_634dc7bd5885a4_33910077',
  'variables' => 
  array (
    'product' => 0,
    'currency' => 0,
...
<?php if ($_valid && !is_callable('content_634dc7bd5885a4_33910077')) {function content_634dc7bd5885a4_33910077($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/fj473748/goldrwsbank.com.ua/www/ru/Smarty/libs/plugins/function.math.php';
?>
...
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable(((string)htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true))." ".((string)htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->brand->name, ENT_QUOTES, 'UTF-8', true)).", цена ".((string)$_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->tpl_vars['product']->value->variant->price))." ".((string)htmlspecialchars($_smarty_tpl->tpl_vars['currency']->value->sign, ENT_QUOTES, 'UTF-8', true))." | Goldrwsbank", null, 1);
...
<section class="header-product gray-page padding2-0">
  <div class="container">
    <div class="product-header-menu">
		...
		<!-- Хлебные крошки /-->
		<div id="path" class="product-header-bread bread-crumbs padding0"> <a class="bread-crumbs--active" href="/ru/">Главная</a> <?php  $_smarty_tpl->tpl_vars['cat'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['cat']->_loop = false;
...
<!--									  	<input type="submit" class="button" value="Сделать резерв" data-result-text="В корзине">-->
	 ...
	 <div id="features" class="product-features paddingtop-3">
	 	<?php if ($_smarty_tpl->tpl_vars['product']->value->features) {?> 
		  <h3>Характеристики <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</span></h3>
...
:</label>
      ...
      <div id="description" class="product-description paddingtop-2"> 
		<?php if ($_smarty_tpl->tpl_vars['product']->value->body) {?> 
			<h3>Описание <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</span></h3>
		<?php }?>
...
" data-format=".+" data-notice="Ваше имя">
				  <label for="comment_text">Ваш отзыв</label>
				  <textarea class="comment-textarea" rows="5" id="comment_text" name="text" data-format=".+" data-notice="Ваш отзыв"><?php echo $_smarty_tpl->tpl_vars['comment_text']->value;?>
</textarea>
