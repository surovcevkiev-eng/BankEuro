...
<div class="gray-page">
  <div class="container padding2-0">
    <h1 class="padding2-0"> {if $cart->purchases}В кошику {$cart->total_products} {$cart->total_products|plural:'товар':'товарів':'товару'}
      {else}Кошик порожній{/if} </h1>
    ...
    <form method="post" name="cart">
	  ...
	  <div class="form-cart padding1-0">
			  ...
			  <div class="form cart_form">
				...
				<input name="name" type="text" value="{$name|escape}" data-format=".+" data-notice="Введіть ім'я"/>
				<label>Email</label>
				<input name="email" type="text" value="{$email|escape}" />
				<label>Телефон</label>
				<input name="phone" type="text" value="{$phone|escape}" data-format=".+" data-notice="Введіть телефон"/>
